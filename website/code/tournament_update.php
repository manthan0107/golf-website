...
session_start();
  ...
  if(isset($_POST['submit']))
  {
      ...
      $qry="UPDATE `tounament` SET `id`='$id',`tname`='$tname',`oname`='$oname',`date`='$date',`location`='$location',`email`='$email',`otherd`='$otherd' WHERE id='$id'";
      if(mysqli_query($con,$qry))
      {
        $aleart=1;
      }

      header("location:../../admin/show_tournament.php");
...
<!-- Tournament Form -->
    ...
    <?php
                            $qry="SELECT * FROM `tounament` WHERE id='$id'";
  ...
  <div class="container">
    ...
    <form class="p-4 shadow rounded bg-light" method="post">
      <div class="mb-3">
        ...
        <input type="text" class="form-control" name="tname" placeholder="Enter Tournament Name" 
        value="<?php echo $row['tname']?>" required>
      </div>
      <div class="mb-3">
        <label class="form-label">Organizer Name</label>
        <input type="text" class="form-control" name="oname" placeholder="Organizer Full Name" value="<?php echo $row['oname']?>" required>
      </div>
      <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <input type="text" name="location" class="form-control" value="<?php echo $row['location']?>" placeholder="Tournament Location" required>
      </div>
      <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <textarea class="form-control" name="otherd" rows="4" value="<?php echo $row['otherd']?>" placeholder="Provide details (optional)"></textarea>
      </div>
