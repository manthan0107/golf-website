...
if(isset($_POST['submit']))
{
    ...
    $qry = "UPDATE `membership` SET `name`='$Name', `email`='$Email', `subject`='$Subject', `contact`='$Contact', `message`='$Message' WHERE id='$id'";
    ...
    header("location:../../admin/show_membership.php");
}
...
<head>
    ...
    <style>
        ...
        #hero_section {
            background-image: url(../About_Page/Img/Hero_Background_image.jpg);
        ...
        .member-form-img {
            background-image: url(../About_Page/Img/membership-1.jpg);
            /* height: 90vh; */
            height: auto;
            /* width: 50%; */
            background-position: center;
    ...
    */
        ...
        .team-photo-container #team-1 {
            /* height: 75vh; */
            height: 500px;
            background-image: url(/About_Page/Img/team-01.jpg);
        ...
        .team-photo-container #team-2 {
            height: 500px;
            background-image: url(/About_Page/Img/team-02.jpg);
            /* background-attachment: fixed; */
            filter: brightness(0.8);
        ...
        .team-photo-container #team-3 {
            ...
            width: 100%;
            filter: brightness(0.8);
            background-image: url(/About_Page/Img/team-03.jpg);
            /* background-attachment: fixed; */
            background-size: cover;
            background-position: center;
            background-repeat: no-repeat;
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 mb-4 mb-lg-0">
                <div class="about-image">
                    <img src="../About_Page/Img/about-3.jpg" class="img-fluid rounded" alt="Golf Image" />
    ...
    <div class="join_us_container2 container pb-5">
        <div class="row member-row2 px-1">
            ...
            <div class="col-md-6">
                ...
                <input type="text" id="nameid" name="mname" value="<?php echo htmlspecialchars($row['name']); ?>" class="form-control" required>
            </div>
            <div class="col-md-6">
                <label for="emailid" class="my-2">Your Email</label>
                <input type="email" id="emailid" name="memail" value="<?php echo htmlspecialchars($row['email']); ?>" class="form-control" required>
            </div>
            <!-- Second Line -->
            <div class="col-md-6">
                <label for="subjectid" class="my-2">Your Subject</label>
                <input type="text" id="subjectid" name="msubject" value="<?php echo htmlspecialchars($row['subject']); ?>" class="form-control">
            </div>
            <div class="col-md-6">
                <label for="contactid" class="my-2">Contact Number</label>
                <input type="number" id="contactid" name="mcontact" value="<?php echo htmlspecialchars($row['contact']); ?>" class="form-control">
            </div>
            <!-- Third Line -->
            <div class="col-12">
                <label for="messageid" class="my-2">Message</label>
                <input type="text" id="messageid" name="mmessage" value="<?php echo htmlspecialchars($row['message']); ?>" class="form-control">
            </div>
            <!-- Submit -->
            <div class="col-12">
                <input type="submit" value="Send Message" name="submit" class="btn btn-primary my-4">
            </div>
        </div>
                </form>
            </div>
    ...
    <footer class="footer">
        <div class="footer-left col-xl-4">
            <div class="footer-logo">
                <img src="./Img/footer-light-logo.png" alt="Golf Logo" />
            </div>
            <p>
