...
session_start();
  ...
  if(isset($_POST['submit']))
  {
    ...
    $qry="UPDATE `coaching` SET `id`='$id',`name`='$name',`email`='$email',`cno`='$cno',`age`='$age',`gender`='$gender',`level`='$level',`timeslot`='$timeslot',`message`='$message' WHERE id='$id'";
    ...
    header("location:../../admin/show_coach.php");
        ...
        <div class="row align-items-center g-5">
            ...
            <div class="col-lg-7">
                <div class="form-card">
                    <form method="post" >
                        <?php
                            $qry="SELECT * FROM `coaching` WHERE id='$id'";
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" name="cno" placeholder="Enter your phone number" value="<?php echo $row['cno']?>" required>
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" name="timeslot" value="<?php echo $row['timeslot']?>">
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control" rows="4" name="message" placeholder="Tell us more" value="<?php echo $row['message']?>"></textarea>
                            </div>
